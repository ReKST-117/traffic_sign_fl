...
# ========== Configuration ==========
recv_dir = '/home/nvidia/git/tsfl/log/'  # Directory to receive logs and models from server
send_dir = '/home/nvidia/git/tsfl/model/'  # Directory to send models and logs back to server
client_name = 'jetson'   # Set your device name here
class_list = [
...
while True:
    ...
    for log_file in log_files:
        ...
        js_full = match.group(1)       # e.g., '11'
        round_id = int(js_full[1])     # e.g., '1' from '11'
